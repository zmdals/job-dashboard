...
public class CertificateController {
    ...
    public ApiResponse<List<CertificateRes>> getAll() {
        return ApiResponse.ok(certificateService.getAll());
    }

...
public class ProjectController {
    ...
    @GetMapping
    public ApiResponse<List<ProjectRes>> getAll(@AuthenticationPrincipal CustomUserDetails userDetails) {
    ...
    public ApiResponse<ProjectRes> update(@PathVariable Long projectId,
